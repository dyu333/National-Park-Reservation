...
public class Menu {
	...
	public Object getChoiceFromUserInput(List<Object> options) {
		...
		if ( (options.get(options.size() - 1)).equals("quit") && userInput.equalsIgnoreCase("q") ) {
	...
	public Object getUserChoiceFromAllowables(List<Object> options, List<Long> idNumbers) {
		Object choice = null;
		String userInput = in.nextLine();
